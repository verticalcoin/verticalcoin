...
static boost::signals2::connection genesis_connection;
...
//    nCoinCacheUsage = nTotalCache; // the rest goes to in-memory cache
    ...
    if (chainActive.Tip() == NULL) {
        genesis_connection = uiInterface.NotifyBlockTip.connect(BlockNotifyGenesisWait);
    } else {
        fHaveGenesis = true;
    }
